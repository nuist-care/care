...
@SpringBootTest
@Slf4j
class HealthassessmentServiceTests {
	
	@Autowired
	HealthassessmentService healthassessmentService;

	/**
	 * healthassessmentService测试
	 *  根据评估编号查询
	 *  */
	@Test
	public void test_selectByAssid() {
		Integer assid=new Integer(20001);
		Healthassessment d=healthassessmentService.findByAssid(assid);
	...
	public void test_findAllHealthassessment() {
		Iterable<Healthassessment> d=healthassessmentService.findAllHealthassessment();
		log.info(d.toString());
		log.debug("测试通过");
	...
	public void test_addHealthassessment() throws ParseException  {
		...
		String assresult="感冒";
		boolean h=healthassessmentService.addHealthassessment(aid, assesser, assreason, asstype, asstime, assresult);
	...
	public void test_findByAssidAidAname() {
        List<Healthassessment> hs=healthassessmentService.findByAssidAidAname(2, 2, "z");
	...
	public void test_updateVisiting() throws ParseException {
		...
		Date asstime=sdf.parse("2020-08-23");
		String assresult="感冒";
		boolean h=healthassessmentService.updateHealthassessment(assid, aid, assesser, assreason, asstype, asstime, assresult);
		Assertions.assertNotEquals(0, h);
		log.debug("测试通过！");
	}
