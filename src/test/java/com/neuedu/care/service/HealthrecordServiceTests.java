...
//		Healthrecord d=healthrecordService.findByRid(rid);
...
//		List<Healthrecord> healthrecords=healthrecordService.findByRidAidAname(1, 2, "");
//		Assertions.assertNotEquals(0, healthrecords.size());
//		System.out.println(healthrecords);
//		log.debug("测试通过！");
//	}
...
//		boolean s = healthrecordService.addHealthrecord(10002, 77, 66, 66, 66);
...
//		boolean s = healthrecordService.updateHealthrecord(50001, 10001, 88, 88, 99, 99);
//		Assertions.assertNotEquals(0, s);
//		log.debug("测试通过！");
//	}
